...
public sealed class AtataContextBuilderTests
{
    ...
    public void WhenThereIsBaseConfiguration()
    {
        try
        {
            ...
            builder.EventSubscriptions.GetItemsForScope(AtataContextScope.Test).Should().HaveCount(2);
    ...
    public void Clear()
    {
        ...
        newBuilder.EventSubscriptions.GetItemsForScope(AtataContextScope.Test).Should().BeEmpty();
