namespace Atata.WebDriver.IntegrationTests.Controls;
...
public class ControlListTests : WebDriverSessionTestSuite
{
    ...
    public sealed class WhenItemsAreRemoving : WebDriverSessionTestSuite
    {
        ...
        // TODO: Review later the following flaky tests. ControlList at the moment is not able to 100% reliably handle such scenarios.
        ////[Test]
        ////public void Should_Contain_ByContent() =>
